...
def page_plot_box():
    ...
    choice_y=st.selectbox('y variable',df_selected.columns.tolist())
    choice_x=st.selectbox('x variable',['Is_Female','Is_graduate','Is_married','Is_urban','Is_self_employed','Loan_Status','Credit History','Dependents'])
